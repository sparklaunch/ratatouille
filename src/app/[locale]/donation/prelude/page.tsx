...
export default async function PreludePage() {
    ...
    return <>
        ...
        <div className={styles.preludeMainContainer}>
            <Image src="/images/PreludeMain.webp" alt={t("main-image-alternate")} fill />
            <Link href="/">
        ...
        <div className={styles.preludeBackgroundContainer}>
            <Image src="/images/PreludeBackground.webp" alt={t("background-image-alternate")} fill />
            <div className={styles.preludeBackgroundContent}>
                <h3>{t.rich("background-text", richFormatter())}</h3>
                <Image src="/images/PreludeForeground.webp" alt={t("foreground-image-alternate")} fill />
            </div>
        </div>
        ...
        <div className={styles.firstAmbientContainer}>
            <Image src="/images/FirstAmbientBackground.webp" alt={t("ambient-first-background-image-alternate")} fill />
            <div className={styles.firstAmbientContent}>
                ...
                <Image src="/images/FirstAmbient.webp" alt={t("ambient-first-image-alternate")} fill />
            </div>
        </div>
        <div className={styles.lastAmbientContainer}>
            <Image src="/images/LastAmbientBackground.webp" alt={t("ambient-last-background-image-alternate")} fill />
            <div className={styles.lastAmbientContent}>
                <h5>{t("ambient-last-text-0")}</h5>
                <p>{t.rich("ambient-last-text-1", richFormatter())}</p>
                <Image src="/images/LastAmbient.webp" alt={t("ambient-last-image-alternate")} fill />
            </div>
        </div>
