    ...
    return <div className={styles.pressContainer}>
        <div className={styles.articlesContainer}>
            {articles.map(article => {
                return <Link href={`/admin/main/articles/${article.id}`} className={styles.articleContainer} key={article.id}>
        ...
        <div className={styles.pagination}>
            <p
                onClick={() => {
                    if (currentPage > 1) {
                        router.push(`/admin/main/articles?page=${currentPage - 1}`);
                    }
                }}
                ...
                [...Array(pageRange)].map((_, index) => {
                    ...
                    return (
                        <p
                            key={page}
                            onClick={() => {
                                router.push(`/admin/main/articles?page=${page}`);
                            }}
